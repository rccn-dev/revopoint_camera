...
def generate_launch_description():
    ...
    tf_args = [
        ...
        ["--frame-id", [tf_prefix, "/", namespace, "_rgb_frame"],
         ...
         "--roll", "-1.5707963267948966", "--yaw", "-1.5707963267948966"],
        ["--frame-id", [tf_prefix, "/", namespace, "_link"],
         "--child-frame-id", [tf_prefix, "/", namespace, "_ir_frame"],
         "--y", "-0.02"],
        ["--frame-id", [tf_prefix, "/", namespace, "_ir_frame"],
         "--child-frame-id", [tf_prefix, "/", namespace, "_ir_optical_frame"],
         "--roll", "-1.5707963267948966", "--yaw", "-1.5707963267948966"],
    ]
    ...
    nodes = [
        ...
        for i, args in enumerate(tf_args)
    ]
